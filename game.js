...
let meta = Object.assign({
  ...
  unlocked: ['dash', 'mayu', 'kenpa', 'spin', 'homura'], slots: { W: 'dash', A: 'kenpa', S: 'spin', D: 'homura' },
...
function reset() {
  player = {
    ...
    spinTimer: 0, spinCd: 0, kenpaCd: 0, homuraCd: 0, mayuCd: 0, mayuTimer: 0, raijinCd: 0, triCd: 0, dashCd: 0, dashTimer: 0, shikkuCd: 0, bombCd: 0, bombCharging: false, bombCharge: 0, jumpHeld: false,
...
const CASTERS = { kenpa: castKenpa, homura: castHomura, spin: castSpin, mayu: castMayu, raijin: castRaijin, tri: castTri, dash: castDash };   // 疾駆は枠スキルでなく専用キー(ろ/RB)から castShikku を直接呼ぶ
...
function update(dt) {
  ...
  for (const k of ['pogoCd','upCd','nailCd','spinCd','kenpaCd','homuraCd','mayuCd','raijinCd','triCd','dashCd','shikkuCd','bombCd','pogoTimer','upTimer','nailTimer','spinTimer','mayuTimer']) if (p[k] > 0) p[k] -= dt;
