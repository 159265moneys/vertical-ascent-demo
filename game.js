...
const CONFIG = {
  ...
  HP_GHOST: 3, GHOST_CHASE: 46, GHOST_FRAME_T: 0.14, GHOST_DRAW_H: 58, GHOST_ORBIT_SPD: 1.0, GHOST_ORBIT_R: 44, GHOST_ORB_H: 19, GHOST_ORB_PULSE: 0.38, GHOST_ORB_HITR: 10, DMG_GHOST: 1,   // 毒ゴースト：HP/追尾速/浮遊コマ間隔/描画高/回転速(遅)/軌道半径/球サイズ/球大小幅/球当たり半径/接触ダメ
  // --- 敵→自分 ダメージ（1/4ハート単位）---
...
const SPRITE_VER = 19;   // スプライト差し替え時にbump＝ブラウザ画像キャッシュ回避
