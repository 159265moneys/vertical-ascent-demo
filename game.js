...
const CONFIG = {
  ...
  BOMB_RADIUS: 88, BOMB_MULT: 2.2, BOMB_LAUNCH: 2100, BOMB_LAUNCH_R: 124, BOMB_IFRAME: 0.12, BOMB_SHAKE: 9, BOMB_EXP_T: 0.32,   // BOMB_LAUNCH=吹き飛ばし(上下左右)の強さ
  UNLOCK_SP: 10,
  // --- チャーム ---
...
function explodeBomb(b) {   // 起爆：AoEダメージ＋敵弾を消す＋プレイヤーを爆心の逆へ吹き飛ばす(真下=大上昇)
  ...
  if (d < CONFIG.BOMB_LAUNCH_R) {   // 吹き飛ばし
    const ux = d > 1 ? dx / d : 0, uy = d > 1 ? dy / d : -1, hmax = CONFIG.MAX_AIR_X * 2.1;
