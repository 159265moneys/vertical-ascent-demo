...
const SPRITE_VER = 7;   // スプライト差し替え時にbump＝ブラウザ画像キャッシュ回避
const sprites = {};
SPRITE_STATES.forEach(s => { const img = new Image(); img.ok = false; img.onload = () => img.ok = true; img.src = `assets/sprites/${s}.png?v=${SPRITE_VER}`; sprites[s] = img; });
